    ...
    return (
        <div className="header">
            <div className="header__left">
                <img src="https://cdn2.iconfinder.com/data/icons/popular-social-media-flat/48/Popular_Social_Media-04-512.png" alt="Logo"  />
                <div  className="header__input"  > <SearchIcon />  <input type="text" placeholder="Search Facebook" /> </div>
            </div>
            ...
            <div className="header__right">
                ...
                <div className="header__info">
                    <Avatar src="https://i4.lisimg.com/15345824/280full.jpg" />
                    <h4>UserUserUser</h4>
                    <IconButton>
                        <AddIcon />
                    </IconButton>
